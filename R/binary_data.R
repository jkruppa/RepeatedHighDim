...
##' @param R Desired covariance matrix the data should have after
##'   running the genetic algorithm
##' @param T Maximum number of iterations after which the genetic
##'   algorithm stops
##' @param e.min Minimum error between the covariance of the
...
##'  \describe{
##' \item{\emph{Xt}}{Final data with specified marginal probabilities and a covariance as close as possible to V} 
##' \item{\emph{t}}{Number of performed iteration steps (t <= T)}
##' \item{\emph{Rt}}{Covariance matrix of Xt}
##' \item{\emph{RMSE}}{Final RSME error between desired and achieved covariance matrix }
##' }
##' @author Jochen Kruppa, Klaus Jung
##' @export
##' @examples
...
##' @param R Specified covariance matrix
##' @param Rt Covariance matrix of the data generated by the genetic
##'   algorithm
