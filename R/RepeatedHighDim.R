...
#' @author Klaus Jung \email{Klaus.Jung@@tiho-hannover.de}
#' @keywords package
#' @references
#' \itemize{
...
#' 	\item{Jung K, Dihazi H, Bibi A, Dihazi GH and Beißbarth T (2014): Adaption of the Global Test Idea to Proteomics Data with Missing Values. Bioinformatics, 30, 1424-30.}
#' 	\item{Kruppa J, Kramer K, Beißbarth T and Jung K (2016): A simulation framework for correlated count data of feature subsets in high-throughput sequencing or proteomics experiments. Statistical Applications in Genetics and Molecular Biology, 15, 401-414}
#' }
#' @examples
